...
public class HtmlCleaner {
    ...
    {
        // DONE Fill in stripEntities(...) implementation.
    ...
    {
        // DONE Fill in stripTags(...) implementation.
    ...
    {
        // DONE Fill in stripComments(...) implementation.
    ...
    {
        // DONE Fill in stripElement(...) implementation.
        return html.replaceAll("(?i)(?s)<\\s*?" + name + "\\s*?.*?<\\/\\s*?" + name + "\\s*?>", " ");    
    }
}
